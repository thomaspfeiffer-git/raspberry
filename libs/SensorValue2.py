...
class SensorValue_Data (object):
    ...
    class Types:
        ...
        Temp, Humi, Pressure, Switch, Light, Wind, WindDir, Desc, IconUrl, AirQuality, Aw_Price, Power = range(12)
    ...
    def value (self, _value):
        ...
        if self.__type in (SensorValue_Data.Types.Temp, SensorValue_Data.Types.Humi,
                           ...
                           SensorValue_Data.Types.Aw_Price, SensorValue_Data.Types.Power):
