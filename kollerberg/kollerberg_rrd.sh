...
DS:kb_i_humi:GAUGE:$HEARTBEAT:0:100 \
DS:kb_i_press:GAUGE:$HEARTBEAT:960:1040 \
DS:kb_a_t1:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_a_t2:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_a_tcpu:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_a_humi:GAUGE:$HEARTBEAT:0:100 \
DS:kb_a_press:GAUGE:$HEARTBEAT:960:1040 \
DS:kb_k_t1:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_k_t2:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_k_tcpu:GAUGE:$HEARTBEAT:-40:80 \
DS:kb_k_humi:GAUGE:$HEARTBEAT:0:100 \
DS:kb_k_press:GAUGE:$HEARTBEAT:960:1040 \
