...
while True:
     ...
     print("{}: {:>8.2f}:{:>8.2f}:{:>8.2f}:{:>8.2f}:{:>8.2f}:{:>8.2f}:{:>8.2f}".format(strftime("%H:%M:%S")), bmp180_pressure, bmp180_temperature, bme280_pressure, bme280_temperature, bme280_humidity, mcp9808_1_temp, mcp9808_2_temp)
